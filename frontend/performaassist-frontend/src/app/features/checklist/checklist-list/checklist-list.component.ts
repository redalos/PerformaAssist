    ...
    <div class="space-y-6">
      ...
      <div class="bg-white shadow rounded-lg p-6">
        <div class="text-center py-12">
          ...
          <h3 class="mt-2 text-sm font-medium text-gray-900">Aucune exécution de checklist</h3>
          <p class="mt-1 text-sm text-gray-500">Commencez par créer un modèle de checklist.</p>
          <div class="mt-6">
            <button 
              routerLink="/checklists/templates/new"
              class="btn-primary">
